package com.thot.curso.boot.web.controller;
...
import com.thot.curso.boot.domain.UF;
import com.thot.curso.boot.service.CargoService;
import com.thot.curso.boot.service.FuncionarioService;
import com.thot.curso.boot.web.validator.FuncionarioValidator;
...
public class FuncionarioController {
	...
	public String excluir(@PathVariable("id") Long id, RedirectAttributes attr) {
		...
		attr.addFlashAttribute("funcionario", "Funcionário excluido com sucesso!");
